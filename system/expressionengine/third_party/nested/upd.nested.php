...
/**
 * Nested Entries Module Install/Update File
 *
 * @package		ExpressionEngine
 * @subpackage	Addons
 * @category	Module
...
class Nested_upd {
	...
	public function uninstall()
	{
		...
		$this->EE->db->where('module_name', 'Nested')
					 ->delete('modules');
...
/* End of file upd.nested.php */
/* Location: /system/expressionengine/third_party/nested/upd.nested.php */